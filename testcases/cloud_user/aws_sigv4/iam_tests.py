...
class IAMSigV4Test(EutesterTestCase):
    def __init__(self, extra_args=None):
        """
        Function to initialize testcase
        for AWS SigV4 against IAM Service
        ...
        for region in self.tester.ec2.get_all_regions():
            ...
            iam_endpoint = endpoint.replace('compute',
                                            'euare')
    ...
    def request_params(self):
        ...
        method = 'GET'
        service = 'iam'
        request_parameters = 'Action=GetAccountSummary&Version=2010-05-08'
    ...
    def sigV4Test(self):
        ...
        support for AWS signature 4 for IAM Service.
...
if __name__ == "__main__":
    # Define IAMSigV4Test testcase
    testcase = IAMSigV4Test()
    list = ['sigV4Test']
    unit_list = []
    for test in list:
