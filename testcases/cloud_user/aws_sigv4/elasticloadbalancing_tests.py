...
class ElasticLoadBalancingSigV4Test(EutesterTestCase):
    def __init__(self, extra_args=None):
        """
        Function to initialize testcase
        for AWS SigV4 against ElasticLoadBalancing Service
        ...
        for region in self.tester.ec2.get_all_regions():
            ...
            elb_endpoint = endpoint.replace('compute',
                                            'loadbalancing')
            region_info = {'name': str(region.name),
                           'endpoint': elb_endpoint}
    ...
    def request_params(self):
        ...
        request_parameters = 'Action=DescribeLoadBalancerPolicyTypes&Version=2012-06-01'
    ...
    def sigV4Test(self):
        ...
        support for AWS signature 4 for ElasticLoadBalancing Service.
...
if __name__ == "__main__":
    # Define ElasticLoadBalancingSigV4Test testcase
    testcase = ElasticLoadBalancingSigV4Test()
    list = ['sigV4Test']
    unit_list = []
    for test in list:
